...
class CFG:
    ...
    name = 'Mayo STRIP AI Train Pipeline'
    loop = 'train_loop'
    dataset = 'ImageDataset'  # dataset_class.dataclass.py -> FBPDataset, MPLDataset
    model_arch = 'STRIPModel'  # model.model.py -> FBPModel, MPLModel
    model = 'ViT-L/16'
